...
public class NoticeDetailActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getNoticeContentByWS(this.noticeID, TeacherInfo.getInstance().execTeacherID);
//		initView();
//		generateData();
	}
	...
	public void initView() {
		...
		if(this.noticeInfo != null){
			...
			NoticeDetailActivity.this.noticeContentTitle_TextView.setText("");
			NoticeDetailActivity.this.noticePublishTime_TextView.setText("");
			NoticeDetailActivity.this.noticeContent_TextView.setText("");
			NoticeDetailActivity.this.noticePublisher_TextView.setText("");
		}
	...
	// 从服务端获取某一条通知详情；
	public void getNoticeContentByWS(int noticeID, String teacherID){
	...
	private void clickBack(){
		...
		}else if(this.viewInitFrom == 2){	// 表示是从通知栏点击而来；点击返回直接进入到主界面；
			Intent mainIntent = new Intent(NoticeDetailActivity.this, MainActivity.class);
	...
	protected void onNewIntent(Intent intent) {
		...
		this.viewInitFrom = getIntent().getIntExtra("viewInitFrom", 0);
		getNoticeContentByWS(this.noticeID, TeacherInfo.getInstance().teacherID);
	}
