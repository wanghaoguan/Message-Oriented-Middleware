...
import com.ttqeducation.teacher.tools.KnowledgePointArc.thread;
...
public class KnowledgePointArc extends View{
...
private Context context;
	...
	public KnowledgePointArc(Context context, int foregroundColor, int score) {
		super(context);
