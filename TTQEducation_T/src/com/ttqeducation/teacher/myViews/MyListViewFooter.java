 ...
 */
package com.ttqeducation.teacher.myViews;
...
public class MyListViewFooter extends LinearLayout {
	...
	private void initView(Context context) {
		...
		LinearLayout moreView = (LinearLayout) LayoutInflater.from(mContext)
				.inflate(R.layout.mylistview_footer, null);
		addView(moreView);
		...
		mProgressBar = moreView
				.findViewById(R.id.mylistview_footer_progressbar);
		mHintView = (TextView) moreView
				.findViewById(R.id.mylistview_footer_hint_textview);
	}
